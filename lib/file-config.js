...
const HARDWARE_PATH = "/opt/PlanktoScope/hardware.json"
const SOFTWARE_PATH = "/opt/PlanktoScope/config.json"
const CALIBRATION_PATH = "/opt/PlanktoScope/calibration.json"
...
export async function initConfigFiles(hardware_version) {
  await Promise.all([
    ...
    copyFile(
      ...
      "/opt/PlanktoScope/hardware.json",
    ),
