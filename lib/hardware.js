...
import { initConfigFiles, initCalibrationFile, readSoftwareConfig } from "./file-config.js"
...
export async function setHardwareVersion(hardware_version) {
  ...
  await Promise.all([systemctl.init(), initConfigFiles(hardware_version), initCalibrationFile()])
  ...
  await systemctl.restart(
    "planktoscope-org.controller.light",
    "planktoscope-org.controller.pump",
